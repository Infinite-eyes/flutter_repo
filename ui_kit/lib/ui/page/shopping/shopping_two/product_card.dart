...
import 'package:ui_kit/ui/page/shopping/shopping_two/product_desc.dart';
          ...
          child: new Stack(
            children: <Widget>[
              Container(
                  ...
                  child: new Image.network(widget.product.image,
                      fit: BoxFit.cover)),
              Align(
                  ...
                  child: new Container(
                    ...
                    decoration: new BoxDecoration(
                      gradient:
                      new LinearGradient(colors: UIData.kitGradients),

...
class _GotPageState extends State<GotPage> {
  ...
  fetchData() async {
    // var res = await http.get("http://api.tvmaze.com/singlesearch/shows?q=game-of-thrones&embed=episodes");
    var res = await http.get("http://api.tvmaze.com/singlesearch/shows?q=1&embed=episodes");
    print(res.body);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:
          AppBar(elevation: 0.0, centerTitle: true, title: Text("GOT 2019")),
      body: data != null
          ? dataBody(context)
